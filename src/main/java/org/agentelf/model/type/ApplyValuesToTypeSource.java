...
public class ApplyValuesToTypeSource {
    ...
    public void applyValues(AbstractType type, AbstractTypeToSource typeSource) {
        ...
        if(type.methods() != null) {
            for(Method function :  type.methods()) {
                MethodToSource method = typeSource.addMethodWithDocumentation(function.declaration(), function.documentation());
